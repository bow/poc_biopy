...
from biopy import seqio
from biopy.core import alphabet
from biopy.core.file import _IndexedSeqFileProxy, _open_for_random_access
from biopy.core._compat import StringIO, _bytes_to_string, _as_bytes
    ...
    def __iter__(self):
        ...
        if index_offset and index_length:
            ...
            try:
                ...
                import warnings
                from biopy.core.execeptions import BiopythonParserWarning
