...
from biopy.core import file
from biopy.core.alphabet import iupac
from biopy.core.data import iupacdata
from biopy.core.seq import Seq
from biopy.core._compat import zip, range, basestring
...
try:
    from biopy.ext.nexus import cnexus
except ImportError:
