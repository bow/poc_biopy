...
from biopy.core._compat import _binary_to_string_handle, _as_bytes
#Importing these functions with leading underscore as not intended for reuse
from biopy.core._compat import urlopen as _urlopen
from biopy.core._compat import quote as _quote
